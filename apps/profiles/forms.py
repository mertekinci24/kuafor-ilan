...
class JobSeekerProfileForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'full_name', 'bio', 'experience_years', 'skills', 
            'portfolio_images', 'city', 'district', 'is_available'
        ]
        widgets = {
            'full_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Adınız Soyadınız'}),
            ...
            'portfolio_images': forms.Textarea(attrs={'class': 'form-control', 'rows': 2, 'placeholder': 'Çalışma fotoğraflarınızın URL\'leri'}),
